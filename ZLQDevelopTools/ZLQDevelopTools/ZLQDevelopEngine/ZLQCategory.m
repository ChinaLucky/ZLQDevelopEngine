...
- (void)addAnimationWithType:(AnimationType)animationType subType:(AnimationSubType)animationSubType duration:(CGFloat)duration {
    NSArray *typeArray = @[kCATransitionFade,
                           kCATransitionPush,
                           kCATransitionReveal,
                           kCATransitionMoveIn,
                           @"cube",
    ...
    //设置运动type
    animation.type = typeArray[animationType];
    animation.subtype = subTypeArray[animationSubType];
    
    //设置运动速度
    animation.timingFunction =  [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionDefault];
    
    [self.layer addAnimation:animation forKey:[NSString stringWithFormat:@"animation%@", animation.type]];
}
...
- (void)removeAnimationWithType:(AnimationType)animationType {
    ...
    [self.layer removeAnimationForKey:[NSString stringWithFormat:@"animation%@", typeArray[animationType]]];
}
...
@implementation UIButton (ZLQExt)
